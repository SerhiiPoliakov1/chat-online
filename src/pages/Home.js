...
const Home = (props) => {
  ...
  const getAllUsers = async (e) => {
    ...
    const response = await fetch("http://192.168.141.19:8080/users", {
      method: 'GET',
      headers: {
  ...
  const submit1 = async (e) => {
    e.preventDefault();
    await fetch("http://192.168.141.19:8080/users", {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer '.concat(sessionStorage.getItem('jwt')),
  ...
  const getChat = async () => {
    const response = await fetch("http://192.168.141.19:8080/api/user/".concat(currentUser.id).concat("/chat/recipient/").concat(userStartChat.id), {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer '.concat(sessionStorage.getItem('jwt')),
  ...
  const checkChatOnExist = async (recipientId, senderId) => {
    const response = await fetch("http://192.168.141.19:8080/api/user/".concat(senderId).concat("/chat/recipient/").concat(recipientId), {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer '.concat(sessionStorage.getItem('jwt')),
  ...
  const getCurrentUser = async () => {
    ...
    const response = await fetch("http://192.168.141.19:8080/users/current",
      {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
  ...
  const createChat = async (recipient) => {
    const response = await fetch("http://192.168.141.19:8080/api/user/".concat(currentUser.id).concat("/chat/add/").concat(recipient.id),
      {
        method: 'POST',
        headers: {
  ...
  const sendMessage = async (e) => {
    ...
    console.log(currentUser)
    await fetch("http://192.168.141.19:8080/api/user/".concat(currentUser.id).concat("/message/send"), {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer '.concat(sessionStorage.getItem('jwt')),
  ...
  const getMessagesFromChat =
    async () => {
      ...
      if (currentUser && currentUser.id !== undefined && userStartChat && userStartChat.id !== undefined) {
        const response = await fetch("http://192.168.141.19:8080/api/user/".concat(currentUser.id).concat("/chat/").concat(userStartChat.id).concat("/message"),
          {
            method: 'GET',
            headers: {
              'Content-Type': 'application/json',
